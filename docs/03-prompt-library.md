...
### Prompt 3.4: Zustand Store Generator
...
### Prompt 3.5: Axios API Client with JWT Refresh Interceptors
...
### Prompt 3.6: IndexedDB Helper Generator (using idb library)
...
### Prompt 3.7: Vitest + React Testing Library UI Test Generator
...
### Prompt 3.8: Playwright E2E Test Generator
...
### Prompt 3.9: React Router DOM v6 Navigation Setup
